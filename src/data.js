...
export const profile = {
  ...
  available: true,
  showreelYear: '2026',
  avatar: '/about-card-bg.jpg',
  showreelVideo: '/about-showreel.mp4',
...
export const works = {
  ai: [
    ...
    // 后续上传的新 AI 项目可以独立添加为新的卡片
    {
      ...
      posterSrc: '/ai-nightingale-banner.jpg',  // 夜莺航行主视觉 banner（黄蓝飞船·太空城市场景）
      // 产品图集（点击展开详情弹窗，与 VI 平面卡片详情样式一致）
      gallery: [
        '/ai-nightingale-8-character-sheet.jpg', // SKY-001 角色设定（置顶·最新上传）
        '/ai-nightingale-1-ostrich.jpg',     // 驼鸟骑行·沙漠
        '/ai-nightingale-2-capsule.jpg',     // 机甲操控胶囊·废墟
        '/ai-nightingale-3-poster1.jpg',      // 宇宙飞船系列海报
        '/ai-nightingale-4-savanna.jpg',      // 非洲草原·跳跃
        '/ai-nightingale-5-back.jpg',         // 未来机甲背影·赛博城市
        '/ai-nightingale-6-cockpit.jpg',      // 驾驶舱
        '/ai-nightingale-7-overview.jpg',     // IP 设定总览
      ],
      // 视频 Demo（点击播放视频）
    ...
    // 超级杯：银河德比 — 新项目（待补图集+视频）
    {
      ...
      tag: 'AI Art',
      type: 'project',  // project 类型：卡片上同时有产品图集热区和视频热区
      posterSrc: '/ai-elclasico-banner.jpg',  // 银河德比主视觉 banner
      // 产品图集
      gallery: [
        '/ai-elclasico-1-cr7-pixie.png',        // C罗·Q版三视图（白·7号）
        '/ai-elclasico-2-cr7-single.png',       // C罗·单人站姿
        '/ai-elclasico-3-messi-neymar-dual.png', // 梅西+内马尔·双人对峙
        '/ai-elclasico-4-messi-turnaround.png',  // 梅西·Q版三视图（蓝红·10号）
        '/ai-elclasico-5-neymar-turnaround.png',  // 内马尔·Q版三视图（蓝红·11号）
      ],
      // 视频 Demo（点击播放视频）
      videoSrc: '/work-elclasico.mp4',
      projectInfo: {
  ...
  ui: [
    {
      ...
      detailSrc: '/work-jinKongZhangGui.webp',
      projectInfo: {
  ...
  vi: [
    {
      ...
      gallery: [
        '/vi-binlan-1.webp', '/vi-binlan-2.webp', '/vi-binlan-3.webp',
        '/vi-binlan-4.webp', '/vi-binlan-5.webp', '/vi-binlan-6.webp',
      ],
      projectInfo: {
    ...
    },
    {
      ...
      gallery: [
        '/vi-poster-1.webp', '/vi-poster-2.webp', '/vi-poster-3.webp',
        '/vi-poster-4.webp', '/vi-poster-5.webp', '/vi-poster-6.webp',
      ],
      projectInfo: {
    ...
    },
    {
      ...
      tag: 'VI Design',
      type: 'gallery',
      posterSrc: '/vi-materials-nightingale-1.jpg',
      gallery: [
        '/vi-materials-nightingale-1.jpg',
        '/vi-materials-nightingale-2.jpg',
      ],
      projectInfo: {
